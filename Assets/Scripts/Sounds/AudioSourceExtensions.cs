...
namespace SoundSystem
{
    public static class AudioSourceExtensions
    {
        ...
        public static IEnumerator PlayRandomStart(this AudioSource audioSource, AudioClip audioClip,
            float volume = 1f)
        {
            ...
            // 結果がlengthと同値になるとシークエラーを起こすため -0.01秒ずらす
        ...
        public static IEnumerator PlayWithFadeIn(this AudioSource audioSource, AudioClip audioClip,
            float fadeTime = 0.1f, float endVolume = 1.0f)
        {
            // 目標ボリュームを0から1に補正
